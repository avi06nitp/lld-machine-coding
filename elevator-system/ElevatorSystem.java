...
public class ElevatorSystem {
    ...
    private static final ElevatorMatchingService matchingService = new ElevatorMatchingService();
    ...
    public static void main(String[] args) {
        ...
        // Scenario 1: External CALL requests from different floors
        ...
        // Scenario 2: Internal SELECT requests from inside an elevator
        System.out.println("\n=== Scenario 2: Internal SELECTs ===");
        selectInternal(e1, 7);
        selectInternal(e2, 1);

        // Scenario 3: Step the simulation several times
        ...
        // Scenario 5: Edge cases - extreme floors
    ...
    private static Elevator callExternal(int floor, ExternalRequestDirection direction) {
        Requests req = new Requests.RequestBuilder()
