...
| 3 | [Parking Lot System](./parking-lot) | Factory for Vehicle, Singleton for Parking Lot |
| 4 | [Cab Booking System](./cab-booking) | Observer for Ride Matching, Factory for Vehicle |
| 5 | [Splitwise Clone](./splitwise) | Strategy for Expense Split, Observer for Notifications |

### Intermediate Level

| # | Project Name | Design Patterns Used |
|---|--------------|---------------------|
| 6 | [Rate Limiter](./rate-limiter) | Token Bucket, Sliding Window - Strategy Pattern |
| 7 | [Elevator System](./elevator-system) | Command for Requests, Observer for Floor Updates |
| 8 | [Library Management System](./library-management) | Factory for Books, Singleton for Database Access |
| 9 | [Hotel Booking System](./hotel-booking) | Strategy for Pricing, Observer for Availability Updates |
| 10 | [In-Memory Key-Value Store (Redis Clone)](./key-value-store) | LRU Cache - Strategy, Singleton for Storage |
| 11 | [Message Queue System (RabbitMQ Clone)](./message-queue) | Publisher-Subscriber, Observer Pattern |
| 12 | [URL Shortener (Bit.ly Clone)](./url-shortener) | Factory for Generating Short Links, Caching |
| 13 | [Stock Trading Platform](./stock-trading) | Observer for Price Updates, Factory for Order Matching |
| 14 | [Search Autocomplete System](./search-autocomplete) | Trie Data Structure, Observer for Query Logging |
| 15 | [Food Delivery App (Zomato Clone)](./food-delivery) | Strategy for Delivery Assignment, Observer for Order Updates |

### Advanced Level

| # | Project Name | Design Patterns Used |
|---|--------------|---------------------|
| 16 | [Distributed Cache (LRU, LFU)](./distributed-cache) | LRU Cache, Singleton for Cache Store |
| 17 | [Real-time Chat Application (WhatsApp Clone)](./chat-application) | WebSockets, Observer for Message Events |
| 18 | [Event Ticket Booking System](./ticket-booking) | Concurrency Control, CQRS for Read Optimization |
| 19 | [Multiplayer Online Chess Game](./chess-game) | Command for Moves, Observer for Game State Updates |
| 20 | [Blockchain-based Ledger System](./blockchain-ledger) | Merkle Tree, Immutable Transactions, Factory for Blocks |
| 21 | [AI-Based Code Review System](./code-review-system) | Command for Code Analysis, Strategy for Rule Checking |
| 22 | [Payment Gateway System](./payment-gateway) | State Pattern for Payment Lifecycle, Observer for Transactions |
| 23 | [Ride-Sharing App (Uber Clone)](./ride-sharing) | Graph Algorithm for Route Optimization, Observer for Ride Matching |
| 24 | [Online Code Compiler](./online-compiler) | Command for Code Execution, Factory for Language Selection |
| 25 | [API Gateway with Authentication](./api-gateway) | Singleton for Authentication Manager, Proxy for Routing Requests |
